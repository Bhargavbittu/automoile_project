...
public class OperatorDaoImpl implements OperatorDao {
    ...
    public boolean addOpertor(Operator o) {
        ...
        try {
            ...
            String sql = "insert into Operators(username, password, permissions) values (?,?,?)";
            ps = con.prepareStatement(sql);
    ...
    public boolean blockOperator(String username) {
        ...
        try {
            con = JDBCHelper.getConnection();
            con.setAutoCommit(false);
            String sql = "update Operators set permissions = ? where username = ?";
            ps = con.prepareStatement(sql);
    ...
    public boolean validate(String username, String password) {
        ...
        try {
            con = JDBCHelper.getConnection();
            String sql = "select * from operators where (username = ? && password = ? && permissions = ?)";
            ps = con.prepareStatement(sql);
